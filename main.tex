...
\end{align*}
Um das $\omega$ noch aufzulösen, fande ich den Weg über die physikalischen Formeln hilfreich, um eine 
...
\end{align*}
Um jetzt die Frequenz $f$ aufzulösen, habe ich mein Modell weiter verwendet. In der Physik gilt: 
...
mein Ergebnis für die DFT gewesen. Mein Ergebnis lässt sich auch wie folgt umstellen:
\begin{align*}
...
tatsächliche DFT die Berechnung über die gleiche Approximation, wie in der ersten Graphik des Abschnitts, führt.
