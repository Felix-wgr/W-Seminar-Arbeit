...
\usepackage{amsmath, amssymb, amsthm, pdflscape, graphicx, pgfplots, tikz, forest, xcolor, lstlinebgrd, mdframed}
\usepackage{lmodern} 
...
\subsection{Vergleich der verschiedenen FFT-Varianten}
\begin{figure}[h!]
\centering
\begin{tikzpicture}
\begin{axis}[
