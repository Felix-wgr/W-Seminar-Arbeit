...
%\[\int_{-\pi}^{\pi} q_n(x) \cdot \overline{q_n(x)} \, dx\]
%\[= \frac{1}{2\pi} \int_{-\pi}^{\pi} e^{inx} \cdot e^{-inx} \, dx\]
%\[= \frac{1}{2\pi} \int_{-\pi}^{\pi} e^{i(n-n)x} \, dx\]
%\[= \frac{1}{2\pi} \int_{-\pi}^{\pi} e^{i\cdot0} \, dx\]
%\[= \frac{1}{2\pi} \int_{-\pi}^{\pi} 1 \, dx = \frac{1}{2\pi} \cdot x \Big|_{-\pi}^{\pi}\]
%\[= \frac{1}{2\pi} \cdot (\pi-(-\pi)) = 1\]
